<?php
	...
	if ( in_array( 'administrator', (array) $user->roles ) ) {
		...
		echo __('<h5> Check your website is responsive or not. </h5>','blog-security-auditor');
		...
		if( $first >= 0 || $second >= 0 || $third >= 0 ) {
			echo '<div class="alert alert-info alert-with-icon alert alert-success">
				    ...
				    <span data-notify="message">'.__('<b> Success - </b> Your website is responsive','blog-security-auditor').'</span>
				    <br />
				    <span data-notify="message">'.__('<b> Good Job</b> Your website passed various responsiveness tests.','blog-security-auditor').'</span>
			...
			echo '<div class="alert alert-info alert-with-icon alert alert-danger">
					...
					<span data-notify="message">'.__('<b> Warning - </b> Your website is not responsive <br /> Find a responsive theme to be mobile friendly with theme shops like elegantthemes and woothemes. ','blog-security-auditor').'</span>
				</div>';
		}
	}
?>